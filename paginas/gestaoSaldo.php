...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
            <div class="container px-5">
                <a class="navbar-brand" href="areaPessoal.php">Condomínio PHP</a>
    ...
    <?php 
        ...
        if(isset($_SESSION['despesa_status']))
        {
            ?>
                <div class="alert alert-warning alert-dismissible fade show" role="alert">
                    <strong></strong> <?= $_SESSION['despesa_status']; ?>
                    <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                </div>
            <?php 
            unset($_SESSION['despesa_status']);
        }
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-12 btnAdicionar">
                <a class="btn btn-primary" href="pagAddDespesas.php">Adicionar Despesas</a>
            </div>                          
        </div>
    </div>
    <!-- Footer-->
